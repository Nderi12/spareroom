...
class SpareBot:
    ...
    def login(self):
        self.driver.get("https://www.spareroom.co.uk/flatmate/flatmates.pl?search_id=1273478583&")
        time.sleep(2)
    ...
    def open_ad_by_index(self, index):
        if 0 <= index < len(self.ad_url_list):
            self.driver.get(self.ad_url_list[index])
        else:
            print("Invalid index. Index should be within the range of available ads.")
